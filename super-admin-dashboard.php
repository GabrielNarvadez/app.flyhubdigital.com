...
/* Reduce too much vertical/horizontal padding */
...
/* Main stats cards tighter and more modern */
...
/* Feature Apps/Modules and Whats New section */
.card .btn,
.card .btn-sm {
...
/* Tables (if used in activity) */
.dashboard-table td, .dashboard-table th {
    font-size: 0.97rem !important;
    padding: 0.38rem 0.65rem !important;
}

/* Fix for dense cards in lower dashboard rows */
.row > [class*='col-'] > .card {
